...
<body>
    ...
    <div class="terminos-container">
        ...
        <p>Al acceder y utilizar el sitio web de Zona Gamer, el usuario acepta automáticamente los siguientes términos y
            condiciones.</p> <br>
        ...
        <p>Zona Gamer se compromete a realizar envíos en el menor tiempo posible y a proporcionar información clara
            sobre costos de envío y plazos de entrega.
        ...
        <p>La información del usuario se recopila y utiliza de acuerdo con nuestra Política de Privacidad.
            Se implementan medidas de seguridad para proteger la información del usuario durante las transacciones. </p>
        <br>
        ...
        <p>Zona Gamer no se hace responsable de pérdidas, daños o problemas resultantes del uso del sitio o de los
            productos adquiridos.</p> <br>

        <h3>10. Ley Aplicable:</h3>
        <p>Estos términos y condiciones están sujetos a las leyes de [país] y cualquier disputa se resolverá en los
            tribunales de [ciudad].</p> <br>

        <h3>11. Contacto:</h3>
        <p>Para consultas, comentarios o asistencia, puedes contactarnos a través de la información proporcionada en la
            sección de "Contacto" en el sitio web.</p> <br><br>
    </div>
